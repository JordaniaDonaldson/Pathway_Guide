...
//
 ...
 //       final IncrementalChange $change = chooseCompletedClasses.$change;
  //      if ($change != null) {
  //          $change.access$dispatch("access$000.(Lcom/example/nicholas/buttontest/chooseCompletedClasses;Landroid/view/ViewGroup;)V", new Object[] { chooseCompletedClasses, viewGroup });
  //          return;
 //       }
